	...
	;FREQUENCY ADJUSTMENT:		ROTARY ENCODER EC11
	...
	.ORG	30H
MAIN:	MOV	R7, #0
	CLR	00H		;HELP DEBOUNCING
	CLR	01H
	CLR	02H		;NOT TO SEND FREQUENCY
	;BIT 03H, 04H NEED NOT TO BE INITIALIZED
	;03H INDICATES FREQ INC/DEC, 04H IS FOR SAVING CARRY
	...
	MOV	R3, #00H
	ACALL	SENDW
	SETB	TR0		;TIMER1 WORKS FROM THE BEGINNING
LOOP:	ACALL	GETF
	ACALL	GETW
	SJMP	LOOP
